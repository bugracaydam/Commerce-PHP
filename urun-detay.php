...
<head>
	...
	<title><?php echo $uruncek['urun_ad'] ?>E-Ticaret</title>
...
<?php
 ...
 elseif ($_GET['durum']=="no") {
   ?>
 	<script type="text/javascript">
	alert("Yorum uygunsuz içerik barındırıyor...");
</script>
<?php
 }
?>
							...
							while($urunaltcek=$urunaltsor->fetch(PDO::FETCH_ASSOC)) {
								...
								<div class="col-md-4">
									<div class="productwrap">
										<div class="pr-img">
											<div class="hot"></div>
											<a href="urun-<?=seo($urunaltcek["urun_ad"]).'-'.$urunaltcek["urun_id"]?>"><img src="<?php echo $urunfotoce['urunfoto_resimyol'] ?>" alt="" class="img-responsive"></a>
